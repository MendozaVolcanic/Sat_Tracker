...
class Satellite:
    name: str
    sensor: str
    norad_id: int | None      # None para geoestacionarios sin TLE útil
    kind: str                 # "polar" | "geo"
    product: str              # producto volcánico clave
    nrt_latency_min: int      # latencia típica NRT en minutos
    access_url: str
    note: str = ""
...
CATALOG: list[Satellite] = [
    ...
    Satellite(
        ...
        "L2 SO₂ columna troposférica (5.5×3.5 km)",
        180,
    ...
    Satellite(
        ...
        "VJ214 active fires 375 m (NRT)",
        30,
        "https://firms.modaps.eosdis.nasa.gov/",
    ),
    Satellite(
        "Landsat 8", "OLI/TIRS", 39084, "polar",
        "TIRS B10/B11 térmico 100 m, OLI 30 m",
        540,
    ...
    # ── Geoestacionarios (siempre arriba — no se calcula pasaje) ──
    Satellite(
        "GOES-19", "ABI", None, "geo",
        "ABI L1b Full Disk 10 min, Ash RGB, FDCF hot spots",
        5,
        "https://www.star.nesdis.noaa.gov/GOES/",
        "75°W. Cobertura Chile = limbo este. Cadencia 10 min FD / 5 min CONUS.",
    ),
    Satellite(
        "Himawari-9", "AHI", None, "geo",
        "AHI Full Disk 10 min",
        5,
